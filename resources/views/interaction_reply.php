...
<body>
    ...
    <main>
        <article class="h-entry">
            <h1><?= \Indieinabox\Localization\Translator::translate('Reply to') ?>: <a class="u-in-reply-to" href="<?= $page->relpath ?><?= $page->slug ?>"><?= htmlspecialchars($page->title) ?></a></h1>
            ...
            <div style="margin-top: 2em; font-size: 0.9em;">
                <a href="<?= $page->relpath ?><?= $page->slug ?>">&larr; <?= \Indieinabox\Localization\Translator::translate('Back to original post') ?></a>
            </div>
        </article>
    </main>
