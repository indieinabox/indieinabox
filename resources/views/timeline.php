    ...
    <main>
        ...
        <?php if (!empty($mentions)): ?>
            <section class="twtxt-mentions" style="margin-bottom: 3em;">
                <h2><?= \Indieinabox\Localization\Translator::translate('Recent Mentions') ?></h2>
        ...
        <section class="twtxt-timeline">
            <h2><?= \Indieinabox\Localization\Translator::translate('Timeline') ?></h2>
            <?php if (empty($timeline)): ?>
                <p><?= \Indieinabox\Localization\Translator::translate('Your timeline is empty. Follow someone to see updates here!') ?></p>
            <?php else: ?>
                <ul style="list-style: none; padding-left: 0;">
